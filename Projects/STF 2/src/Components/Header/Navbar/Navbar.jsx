...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    <NavLink to="/" className={({ isActive }) => isActive ? "NavbarActive" : "navItem"}>{t('home')}</NavLink>
        ...
        <h3>{t("edu_in_karelia")}</h3>
          <NavLink to="/bachelor" className={({ isActive }) => isActive ? "metaNavn1 IntNavListActive" : "metaNavn1" }>{t('bachelor')}</NavLink>
          <NavLink to="/master" className={({ isActive }) => isActive ? "metaNavn1 IntNavListActive" : "metaNavn1" }>{t('master')}</NavLink>
          <NavLink to="/languagecourse" className={({ isActive }) => isActive ? "metaNavn1 IntNavListActive" : "metaNavn1" }>{t('language_course')}</NavLink> 
          <NavLink to="/vocationaleducation" className={({ isActive }) => isActive ? "metaNavn1 IntNavListActive" : "metaNavn1" }>{t('vocational_education')}</NavLink>
