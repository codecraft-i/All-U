# Generated by Django 5.1.7 on 2025-04-20 03:37
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('backend', '0010_alter_university_details_url'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language_certificate', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='contacts', to='backend.certificate', verbose_name='Til sertifikati')),
            ],
            options={
